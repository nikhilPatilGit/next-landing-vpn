  ...
  return (
    <div className="max-w-screen-xl mt-24 px-8 xl:px-16 mx-auto" id="about">
      <ScrollAnimationWrapper>
        <motion.div
          className="grid grid-flow-row  sm:grid-flow-col grid-rows-2 md:grid-rows-1 sm:grid-cols-2 gap-12 py-6 sm:py-16"
            ...
            <motion.div className="h-full w-full" variants={scrollAnimation}>
              <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                  <h2 className="card-title my-5 text-4xl lg:text-5xl xl:text-6xl font-medium text-black-600 leading-normal">
